...
function editBook() {
  ...
  const createBook = async (e) => {
    ...
    try {
      const response = await fetch("https://bookbackend-7ws9.onrender.com/api/books", {
        method: "PUT",
        body: formData,
      });
  ...
  const removeBook = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://bookbackend-7ws9.onrender.com/api/books/" + bookId,
        {
          method: "DELETE",
        }
      );
        ...
        <form className="bookdetails" onSubmit={createBook}>
          <div className="col-1">
            ...
            {image ? (
              ...
              <img
                src={`https://bookbackend-7ws9.onrender.com/uploads/${thumbnail}`}
                alt="preview image"
              />
            )}
            <input
